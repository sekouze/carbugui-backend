...
router.put('/:stationId/open', requireStationAccess, requireApprovedAccount, dashboardController.toggleOpen);
router.put('/:stationId/products/:product', requireStationAccess, requireApprovedAccount, dashboardController.updateProduct);
